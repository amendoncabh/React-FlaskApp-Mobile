"""
This module contains all database interfacing methods for the GeTrEs
application. You will be working on this file for the majority of M220P.

Each method has a short description, and the methods you must implement
have a doc strings with a short explanation of the task.
